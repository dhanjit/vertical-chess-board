...
architecture** (`pivot_type`) — give four buildable combinations, and each one
...
architecture's penalty hurts a short lever most. Side-by-side comparison with
all the reasoning: [`docs/PIECE_DESIGNS.md`](../docs/PIECE_DESIGNS.md).
...
```powershell
cd hardware
.\build.ps1 matrix -Fn 128 -Out ..\prints            # the four variant folders
